...
public class ImpresorLCD
{
    ...
    /**
     *
     * Metodo encargado de calcular el tamanio total de la matriz
     *
     * @param size Tamaño Segmento Digitos
     * @param numeroImp Numero a Imprimir
     * @param espacio Espacio Entre digitos
     */
    private void calculoTamMatriz(int size, String numeroImp, int espacio)
    {
        ...
        calculoPuntosFijos(digitos, espacio);
    }

    /**
     * Metodo encargado de calcular los puntos fijos por cada numero
     *
     * @param digitos arreglo de digitos
     * @param espacio Espacio entre los digitos
     */

    private void calculoPuntosFijos(char[] digitos, int espacio)
    {
    	int pivotX = 0;

        //Recorremos el arreglo char digitos
     ...
     */
    public void procesoEntradas(String comando, int espacioDig)
    {
        ...
        if(isNumeric(parametros[0]))
        {
            ...
            if(tam <1 || tam >10)
            {
                throw new IllegalArgumentException("El espacio entre los numeros ["+tam
                        + "] debe estar entre 1 y 10");
            }
        }
        else
        {
            throw new IllegalArgumentException("El espacio entre los numeros [" + parametros[0]
                    + "] no es un numero");
        }

        // Realiza la impresion del numero
        calculoTamMatriz(tam, parametros[1], espacioDig);
        //Realiza la impresion de toda la matriz
        imprimirMatriz();
    ...
    static boolean isNumeric(String cadena)
    {
    	...
    	{
    		//Validamos si el caracter no es un numero
